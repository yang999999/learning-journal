...
| 🛒 项目A：直播电商 AI 营销助手 | RAG+工具调用+高并发，贴合商卡/秒杀/竞拍业务 | [查看](projects/project-A-直播电商AI营销助手.md) |
| 📺 项目B：AI 直播 OnCall 助手 | 多Agent+MCP+HITL，贴合直播监控/告警排障 | [查看](projects/project-B-直播电商OnCall助手.md) |
